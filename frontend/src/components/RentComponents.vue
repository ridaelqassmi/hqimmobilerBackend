...
export default {
  ...
  methods: {
    ...
    submitHandler() {
      ...
      let rentingPost = {duree:this.duree,price:this.prix,numberRoom:this.chambre,description:this.description,title:this.title,location:"no where",hasAppliance:false,areaSize:180};
